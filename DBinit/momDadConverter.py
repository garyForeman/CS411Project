...
if __name__ == '__main__':
    ...
    mother = np.genfromtxt(FILE_STRING, usecols=(8), delimiter=',', dtype='int',
                           skip_header=1)
    father = np.genfromtxt(FILE_STRING, usecols=(9), delimiter=',', dtype='int',
                           skip_header=1)
    sex = np.genfromtxt(FILE_STRING, usecols=(10), delimiter=',', dtype='int', 
                        skip_header=1)

    #note: sex == 1 means female, sex == 2 means male
...
#            print cornell_number[i], mother[i]
