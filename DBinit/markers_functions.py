...
def update_marker_data(markername_in, MeioticPos_in, DogChr_in, DogPos_in, FoxChrSeg_in, FoxChr_in, FoxChrPos_in):
    ...
    for attribute in allattributes.keys():
        if attribute != 'markername': #I'm not letting this function change the primary key
...
update_marker_data(markername, MeioticPos, DogChr, DogPos, FoxChrSeg, FoxChr, FoxChrPos)
